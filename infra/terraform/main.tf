...
output "public_bucket_name" { value = yandex_storage_bucket.public_site.bucket }
output "admin_bucket_name" { value = yandex_storage_bucket.admin_panel.bucket }
