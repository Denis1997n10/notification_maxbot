...
regioncity_forms_path="${REGIONCITY_FORMS_PATH:-/formManagement/forms}"
regioncity_media_base_url="${REGIONCITY_MEDIA_BASE_URL:-https://cds1.mpoisk.ru/cds1/d}"
...
regioncity_forms_path = "$regioncity_forms_path"
regioncity_media_base_url = "$regioncity_media_base_url"
